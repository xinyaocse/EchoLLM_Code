...
- TrainSet: Contains training datasets for both the CNN-based voice activity detector and the LeASR module.
  - *CNN_Train*: Training data for the CNN-based voice activity detector (EchoVAD).
