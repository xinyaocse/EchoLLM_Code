...
from dataset.dataset_config import no_bof_dataset, flag_dataset, noised_b_dataset, \
    EvalAdapter, flag_eval, real_b_eval, ablation_flag_real_eval, ablation_no_flag_real_eval

dataset = EvalAdapter()
dataset.set_datasets(ablation_no_flag_real_eval)
    ...
    def _generate_examples(self, files):
        ...
        for id_, item in enumerate(files):
            text_upper = filter_extra_spaces(lowercase_and_remove_punctuation(
               dataset.eval_dataset.get_label(item)))
