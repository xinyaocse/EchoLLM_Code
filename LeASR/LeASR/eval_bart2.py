...
def write_json_result(json_path, text_list, is_aft_pre=True):
    ...
    for index, item in enumerate(files):
        if is_aft_pre:
            item['asr_text_context_real_train'] = text_list[index]
        else:
            item['asr_text_no_context_B'] = text_list[index]
...
def main():
    ...
    def prepare_dataset(batch):
        ...
        return batch
    raw_datasets = get_eval_datasets_bart2(False, True, False)
