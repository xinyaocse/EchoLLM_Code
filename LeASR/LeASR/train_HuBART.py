...
def main():
    ...
    # Filter data that is shorter than min_input_length or longer than max_input_length
    ...
    # For large datasets it's advised to run preprocessing first with `args.preprocessing_only`
    # to avoid timeout in distributed mode
