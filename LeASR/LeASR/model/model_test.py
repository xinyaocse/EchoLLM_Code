...
decoder_id = "./dataset_text_audio/pretrained_models/models/gpt-2/"
...
model.save_pretrained("./dataset_text_audio/pretrained_models/models/mode_h-gppt/")

# load and save processor
feature_extractor = AutoFeatureExtractor.from_pretrained(encoder_id)
tokenizer = AutoTokenizer.from_pretrained(decoder_id)
processor = Wav2Vec2Processor(feature_extractor, tokenizer)
processor.save_pretrained("./dataset_text_audio/pretrained_models/models/mode_h-gppt/")