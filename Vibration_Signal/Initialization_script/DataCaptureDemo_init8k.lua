...
file_path = string.gsub(file_path, "DataCaptureDemo_init8k.lua","");
...
elseif((partId == 1243) or (partId == 1443)) then
    if(ar1.ProfileConfig(0, 77, 83, 6, 42, 0, 0, 0, 0, 0, 0, 89.8, 0, 300, 20000, 0, 0, 30) == 0) then
        WriteToLog("ProfileConfig Success\n", "green")
    else
        WriteToLog("ProfileConfig failure\n", "red")
    end
...
if (ar1.FrameConfig(0, 0, 100, 128, 16.125, 0, 0, 1) == 0) then
